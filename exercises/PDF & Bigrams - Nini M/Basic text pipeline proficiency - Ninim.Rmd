...
This analysis focuses on recurring bigrams and sentiment patterns in a series of articles about Raymond Moley and topics related to the New Deal. The bigram analysis (first chart) highlights the most frequently occurring two-word phrases. "Gold standard" and "White House" are the top bigrams, with frequencies of approximately 43 and 39, respectively. Other significant bigrams include "economic recovery" and "bank holiday," each appearing about 15 times. These phrases underscore critical themes of economic stabilization and fiscal recovery, which were central to the New Deal’s mission. "Bank holiday," in particular, refers to the temporary closure of banks to prevent massive withdrawals, a key early action taken by Roosevelt to restore public confidence in the financial system. This focus on economic recovery measures indicates that these articles were examining both the immediate and long-term impacts of Roosevelt’s interventions.Additionally, phrases like "Keynesian myth" and "federal government" appear frequently, pointing to critical discourse on economic theories and federal policy.
...
In summary, this analysis reveals a complex narrative in the articles, with both high-frequency supportive sentiments and significant critical tones, reflecting the nuanced discourse surrounding economic policies and government intervention in the New Deal era.