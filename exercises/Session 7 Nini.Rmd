...
text <- pdf_text("/Users/ninimtchedlishvili/CompText_Jour-main/exercises/assets/pdfs/kemi.PDF")
#pdf_text reads the text from a PDF file.
writeLines(text, "~/CompText_Jour-main/exercises/assets/extracted_text/kemi_text.txt")
...
file_path <- "~/CompText_Jour-main/exercises/assets/extracted_text/kemi_text.txt"
...
output_dir <- "~/CompText_Jour-main/exercises/assets/extracted_text/"
