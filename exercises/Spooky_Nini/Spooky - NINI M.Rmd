...
text <- pdf_text("/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/Asian_Indian_Women_NYT_LAT_USAT.PDF")
#pdf_text reads the text from a PDF file.
writeLines(text, "/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/Asian_Indian_Women_NYT_LAT_USAT.txt")
...
file_path <- "/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/Asian_Indian_Women_NYT_LAT_USAT.txt"
...
output_dir <- "/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/IA_extracted/"
for (i in seq_along(documents)) {
  output_file <- file.path(output_dir, paste0("IA_extracted", i, ".txt"))
...
IA_index <- read_lines("/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/IA_extracted/IA_extracted1.txt")

extracted_lines <- IA_index[16:230]



cat(extracted_lines, sep = "\n")

extracted_lines <- data.frame(extracted_lines = extracted_lines)
...
write_csv(final_data, "/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/final_data.csv")
...
files <- list.files("/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/extracted_text", pattern="*.txt") %>% 
  as.data.frame() |> 
  rename(filename = 1) |> 
...
#you need the actual hard-coded path on this line below to the text
  ...
  mutate(filepath = paste0("/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/extracted_text/", filename))
...
write.csv(articles_df, "/Users/ninimtchedlishvili/CompText_Jour-main/exercises/Spooky_Nini/extracted_text/IA_extracted_final.csv")
