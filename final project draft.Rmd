...
I updated the project. I am going to make an office hour appointment, so I can figure out why a few codes did not filter stop words below. Also I have questions regarding Donald Trump dataset, I could not decide whether to bring in that in here or to create a new R Markdown document. You can see the Trump excel file in the zip document.
...
Along with the bigrams, I wanted to also present a word cloud. I decided to make an unigram column, but certain words did not get filtered. The codes are running, but the "junk" words are being included in the word cloud. I do not know why.
